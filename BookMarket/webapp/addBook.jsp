...
<script type="text/javascript" src="./resources/js/validation.js"/> <!-- 입력폼 검증코드 -->
<script
...
<body>
<fmt:setLocale value='<%=request.getParameter("language") %>'/> <!-- 웹브라우저의 지역 언어를 가져옴 -->
         ...
         <!-- enctype=""multipart/form-data" : 파일 업로드용 타입 필수 -->
            ...
            <div class="mb-3 row">
               <div class="col-sm-offset-2 col-sm-10 ">
                  ...
                  <!-- onclick="CheckAddBook()" 버튼을 클릭했을때 핸들링 하기위한 방법 js로 감 -->
               </div>
            </div>
